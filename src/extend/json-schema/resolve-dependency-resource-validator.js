...
var ResolveDependencyResourceValidator = /** @class */ (function (_super) {
    __extends(ResolveDependencyResourceValidator, _super);
    function ResolveDependencyResourceValidator() {
     ...
     */
    ResolveDependencyResourceValidator.prototype.validate = function (operations) {
        return _super.prototype.validate.call(this, operations, this.schemas['/resolveResourceSchema']);
    };
    /**
     * 注册所有的校验
     * @private
     */
    ResolveDependencyResourceValidator.prototype.registerValidators = function () {
    ...
    __decorate([
        (0, midway_1.init)()
    ], ResolveDependencyResourceValidator.prototype, "registerValidators");

...
var ResourceFreezeRecordProvider = /** @class */ (function (_super) {
    __extends(ResourceFreezeRecordProvider, _super);
    function ResourceFreezeRecordProvider(model) {
    ...
    return ResourceFreezeRecordProvider;

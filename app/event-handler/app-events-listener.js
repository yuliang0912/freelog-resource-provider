...
const ReleaseSchemeBindContractEventHandler = require('./release-scheme-bind-contract-event-handler')
...
module.exports = class AppEventsListener {
    ...
    registerEventListener() {
        ...
        this.registerEventAndHandler(ResourceEvents.releaseSchemeBindContractEvent)
    ...
    registerEventHandler() {
        ...
        patrun.add({event: ResourceEvents.releaseSchemeBindContractEvent.toString()}, new ReleaseSchemeBindContractEventHandler(app))
